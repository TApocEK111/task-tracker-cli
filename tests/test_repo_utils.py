...
class TestRepoUtils(unittest.TestCase):
    ...
    def test_saves_loads_tasks_simple(self):
        ...
        for i in range(len(self.tasks)):
            self.assertEqual(self.tasks[i].id, loaded[i].id)
            self.assertEqual(self.tasks[i].description, loaded[i].description)
            self.assertEqual(self.tasks[i].createdAt, loaded[i].createdAt)
            self.assertEqual(self.tasks[i].updatedAt, loaded[i].updatedAt)
            self.assertEqual(self.tasks[i].status, loaded[i].status)
